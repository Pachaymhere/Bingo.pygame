...
class TicTacToe:
    def __init__(self, game):
        self.game = game
        self.field_image = self.get_scaled_image(path='C:/Users/DELL/OneDrive/Desktop/Python lab/Pachyam/CAP2_Pygame/resources/field.png', res=[WIN_SIZE] * 2)
        self.O_image = self.get_scaled_image(path='C:/Users/DELL/OneDrive/Desktop/Python lab/Pachyam/CAP2_Pygame/resources/o.png', res=[CELL_SIZE] * 2)
        self.X_image = self.get_scaled_image(path='C:/Users/DELL/OneDrive/Desktop/Python lab/Pachyam/CAP2_Pygame/resources/x.png', res=[CELL_SIZE] * 2)
